...
local L = {
    enUS = {
		...
		GEM4 = "Best for: Not used.",		
		GEM5 = "Best for: Not used.",	
    ...
    ruRU = {
		...
		GEM2 = "Лучший для: Не используются.",
		GEM3 = "Лучший для: Не используются.",
		GEM4 = "Лучший для: ДПС.",
		GEM5 = "Лучший для: Не используются.",
